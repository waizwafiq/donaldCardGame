...
public class _1Player extends DonaldGame {
    ...
    public void play() {
        ...
        setFirstPlayer(player[0]);
        //IN A ROUND:
        do {
            //LOOP FOR ALL PLAYERS TO PLAY
            setFirstPlayer(player[getWinnerPlayerIdx()]);
            boolean flag1 = player[getWinnerPlayerIdx()].getName().equalsIgnoreCase("Computer 1");
